...
const doubtButton = document.querySelector('.doubt-send');
const messageField = document.querySelector('.chat-input');
const doubtField = document.querySelector('.doubt-input');
...
const chatinputcont=document.querySelector('.chat-input-cont');
const doubtinputcont=document.querySelector('.doubt-input-cont');
const chatRoom = document.querySelector('.chat-cont');
const doubtRoom = document.querySelector('.doubt-cont');

doubts.addEventListener('click', ()=>{
    doubtinputcont.classList.remove("hide");
    doubtRoom.classList.remove("hide");

    chatinputcont.classList.add("hide");
    chatRoom.classList.add("hide");

})

chats.addEventListener('click', ()=>{
    chatinputcont.classList.remove("hide");
    chatRoom.classList.remove("hide");

    doubtinputcont.classList.add("hide");
    doubtRoom.classList.add("hide");
})
...
//handling meeting disconnection
